...
6) Hier sucht man sich einen Branch (z.B. main) und ein Folder (z.B. root) aus. Zum Schluss klickt man auf <span style="cursor:default; color:white; background: grey; padding:2px 3px; border-radius: 6px">Save</span>. Siehe das Bild: ![Git Pages](img/gitpages.png)
...
> Anforderungen: Visual Studio Code und Git bereits installiert